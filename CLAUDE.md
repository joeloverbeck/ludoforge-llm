...
- **Completed ticket series** (archived): ENGINEAGNO, TEXHOLKERPRIGAMTOU, ARCHTRACE, MONOREPO, WRKBRIDGE, STATEMOD, PIXIFOUND, ENGINEARCH, REACTUI, ANIMSYS, AGNOSTIC, FRONTEND-F3
...
- **Active tickets**: FITLRULES2-001 through 006 (FITL rules refinement — data-only YAML changes), KERLEGCHO-001 through 003 (kernel legal-choice hardening)
