...
- **Active specs**: 59 (codebase health audit), 60 (decision instance architecture)
- **Pending archival**: 29 (FITL event card encoding; living FITL event authoring guidance now lives in `docs/fitl-event-authoring-cookbook.md`)
- **Active tickets**: None
