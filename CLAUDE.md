...
- **Active specs**: 29 (FITL event card encoding), 31 (FITL E2E tests), 35-00 (frontend roadmap), 42 (visual config & session management), 49 (FITL Section 7 rules gaps), 50 (event interactive choice protocol), 51 (cross-game primitive elevation), 59 (codebase health audit)
...
This project is indexed by GitNexus as **ludoforge-llm** (9158 symbols, 26512 relationships, 300 execution flows).
