...
- **Active specs**: 29 (FITL event card encoding), 59 (codebase health audit), 60 (decision instance architecture)
- **Active tickets**: None
...
This project is indexed by GitNexus as **ludoforge-llm** (9423 symbols, 27426 relationships, 300 execution flows).
