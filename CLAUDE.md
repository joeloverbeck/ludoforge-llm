...
- **Active specs**: 59 (codebase health audit), 70 (bitmap font leak & init perf), 76 (ValueExpr type-tag discriminants), 77 (EffectContext static/dynamic split), 78 (draft state for effect execution), 80 (incremental Zobrist hashing), 81 (whole-sequence effect compilation), 82 (effect AST type tags)
- **Active tickets**: None
