...
## PART ONE – Events, Operations, and Special Activities
...
the Pass box, and then increase NVA resources by +1 to 11, moving the NVA token up one box on the Track. When an Insurgent faction
...
The ARVN Train up and Pacify in Saigon.
