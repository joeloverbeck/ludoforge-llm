...
**Status**: REJECTED
**Rejection note (2026-05-20)**: Rejected before implementation because the AI agent policy system is being overhauled. The composite acceptance, weight-soup lint, and quality-diversity archive design below depends on policy-system assumptions that will be outdated by that overhaul.
