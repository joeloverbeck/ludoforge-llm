...
**Deps**: `archive/specs/165-projected-state-lookup-refs.md`
...
Outcome amended: 2026-05-11 — post-completion archived-ticket outcome normalization, dependency-integrity marker repair, and archived Spec 165 path repair.
...
- `archive/specs/165-projected-state-lookup-refs.md` now records `LookupStateProvenance` as resolver-adjacent in `policy-lookup-surface.ts`, matching Spec §4.2 and this ticket.
...
- Additional owned fallout: `packages/engine/schemas/GameDef.schema.json`, `archive/specs/165-projected-state-lookup-refs.md`.
