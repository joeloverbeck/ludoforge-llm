...
2. Preserve GameSpecDoc as the authored policy surface; VC-specific tactical content returns to `archive/tickets/188FITLFOUFAC-010.md`.
...
After the generic blocker is fixed, `archive/tickets/188FITLFOUFAC-010.md` must be able to resume as Tier-1 YAML authoring with its two headline VC witnesses and broad engine acceptance lane.
...
- Authoring the VC skeleton itself; that returns to `archive/tickets/188FITLFOUFAC-010.md`.
...
3. `archive/tickets/188FITLFOUFAC-010.md` can resume VC YAML authoring after this prerequisite without narrowing its signature-template deliverable or broad-suite proof lane.
...
`archive/tickets/188FITLFOUFAC-010.md` can resume VC YAML authoring with its two headline VC witnesses and broad engine acceptance lane. This ticket did not narrow `010`'s signature-template deliverable or `test:all` proof lane.
