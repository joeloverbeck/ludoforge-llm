#!/usr/bin/env bash
# Evaluation harness for prod-perf-fitl-top3 campaign
...
TARGET_FILES=(
  "dist/test/integration/fitl-events-pathet-lao.test.js"
  "dist/test/integration/fitl-events-brinks-hotel.test.js"
  "dist/test/integration/fitl-events-operation-starlite.test.js"
)
