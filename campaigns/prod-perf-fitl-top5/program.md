# Campaign: prod-perf-fitl-top5

## Objective

Minimize the combined wall-clock time of the 5 slowest FITL integration test suites by optimizing production engine code (hot paths in compiler, kernel, evaluation).
...
- `campaigns/prod-perf-fitl-top5/harness.sh`
