#!/usr/bin/env bash
# Evaluation harness for turn-perf-fitl-combined campaign
...
TARGET_FILES=(
  ...
  "dist/test/integration/fitl-events-sihanouk.test.js"
  "dist/test/integration/fitl-events-brinks-hotel.test.js"
  "dist/test/integration/fitl-events-ia-drang.test.js"
  "dist/test/integration/fitl-events-fact-finding.test.js"
)
...
# --- Step 3: Run target test suites for metric measurement ---
echo "Running target test suites for metric..." >&2
