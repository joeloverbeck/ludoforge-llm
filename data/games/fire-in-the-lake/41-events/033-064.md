                      ...
                      right:
                        aggregate:
                          ...
                          query:
                            query: binding
                            name: $targetSpaces
                          bind: $pleiMeiChainOrigin
                          valueExpr:
                            aggregate:
                              op: sum
                              query:
                                query: binding
                                name: '$chainSpaces@{$pleiMeiChainOrigin}'
                              ...
                              valueExpr:
                                ...
                                left:
                                  aggregate:
                                    ...
                                    query:
                                      query: binding
                                      name: '$continuingGuerrillas@{$pleiMeiChainOrigin}->{$pleiMeiChainDest}'
                                right:
                                  aggregate:
                                    op: count
                                    query:
                                      query: binding
                                      name: '$continuingTroops@{$pleiMeiChainOrigin}->{$pleiMeiChainDest}'
                    right: 0
                  - op: ==
                    left:
                      op: '+'
