    ...
    cards:
      ...
      - id: card-123
        ...
        unshaded:
          ...
          effects:
            # Step 1: +12 ARVN Resources (clamped at max 75 by engine)
            - addVar:
                scope: global
                var: arvnResources
                delta: 12
            # Step 2: +12 Aid (clamped at max 75 by engine)
            - addVar:
                scope: global
                var: aid
                delta: 12
            # Step 3: All out-of-play ARVN pieces move to Available
            - moveAll:
                from: out-of-play-ARVN:none
                to: available-ARVN:none
            # Step 4: Place up to 4 ARVN cubes (troops/police) from Available to any map spaces
            - distributeTokens:
                tokens:
                  query: tokensInZone
                  zone: available-ARVN:none
