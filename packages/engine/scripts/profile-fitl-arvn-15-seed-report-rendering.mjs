...
export function renderMarkdown(rollup, options) {
  ...
  const lines = [
    ...
    `- WASM preview candidate-feature row oracle fallback count: ${sumAggregateField(rollup.perDecisionClass, 'wasmPreviewCandidateFeatureRowOracleFallbackCount')}`,
...
function renderAggregateRow(label, row) {
  return [
    ...
    row.wasmPreviewCandidateFeatureRowOracleFallbackCount,
