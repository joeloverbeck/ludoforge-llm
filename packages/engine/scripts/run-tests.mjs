...
const lanePatterns = {
  ...
  'e2e:mcts:fast': listE2eTestsForLane('e2e:mcts:fast').map(toDistTestPath),
  'e2e:mcts:default': listE2eTestsForLane('e2e:mcts:default').map(toDistTestPath),
  'e2e:mcts:strong': listE2eTestsForLane('e2e:mcts:strong').map(toDistTestPath),
  'e2e:mcts:fitl': listE2eTestsForLane('e2e:mcts:fitl').map(toDistTestPath),
  'e2e:mcts:fitl:fast': listE2eTestsForLane('e2e:mcts:fitl:fast').map(toDistTestPath),
  'e2e:mcts:fitl:default': listE2eTestsForLane('e2e:mcts:fitl:default').map(toDistTestPath),
  'e2e:mcts:fitl:strong': listE2eTestsForLane('e2e:mcts:fitl:strong').map(toDistTestPath),
