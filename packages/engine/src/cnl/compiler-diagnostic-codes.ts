...
const COMPILER_DIAGNOSTIC_CODES_COMPILER_CORE = Object.freeze({
  ...
  CNL_COMPILER_AGENT_PLAN_TEMPLATE_REF_UNKNOWN: 'CNL_COMPILER_AGENT_PLAN_TEMPLATE_REF_UNKNOWN',
  CNL_COMPILER_AGENT_PLAN_TEMPLATE_ROLE_UNBOUND: 'CNL_COMPILER_AGENT_PLAN_TEMPLATE_ROLE_UNBOUND',
  CNL_COMPILER_AGENT_PLAN_TEMPLATE_CAPS_INVALID: 'CNL_COMPILER_AGENT_PLAN_TEMPLATE_CAPS_INVALID',
  CNL_COMPILER_AGENT_PLAN_TEMPLATE_FALLBACK_UNKNOWN: 'CNL_COMPILER_AGENT_PLAN_TEMPLATE_FALLBACK_UNKNOWN',
  CNL_COMPILER_AGENT_PLAN_TEMPLATE_FALLBACK_CYCLE: 'CNL_COMPILER_AGENT_PLAN_TEMPLATE_FALLBACK_CYCLE',
  CNL_COMPILER_AGENT_PLAN_TEMPLATE_STABLE_TIEBREAKER_REQUIRED: 'CNL_COMPILER_AGENT_PLAN_TEMPLATE_STABLE_TIEBREAKER_REQUIRED',
  CNL_COMPILER_AGENT_PLAN_TEMPLATE_CONSTRAINT_UNSUPPORTED: 'CNL_COMPILER_AGENT_PLAN_TEMPLATE_CONSTRAINT_UNSUPPORTED',
  CNL_COMPILER_AGENT_PLAN_TEMPLATE_CONSTRAINT_INVALID: 'CNL_COMPILER_AGENT_PLAN_TEMPLATE_CONSTRAINT_INVALID',
  CNL_COMPILER_AGENT_PLAN_TEMPLATE_ROUTE_GRAPH_MISSING: 'CNL_COMPILER_AGENT_PLAN_TEMPLATE_ROUTE_GRAPH_MISSING',
  CNL_COMPILER_AGENT_PLAN_TEMPLATE_ROUTE_CLASS_UNRESOLVED: 'CNL_COMPILER_AGENT_PLAN_TEMPLATE_ROUTE_CLASS_UNRESOLVED',
  CNL_COMPILER_AGENT_PLAN_TEMPLATE_LOCATED_IN_HIDDEN_CONTAINER: 'CNL_COMPILER_AGENT_PLAN_TEMPLATE_LOCATED_IN_HIDDEN_CONTAINER',
  CNL_COMPILER_AGENT_PLAN_TEMPLATE_STEP_MATCH_INVALID: 'CNL_COMPILER_AGENT_PLAN_TEMPLATE_STEP_MATCH_INVALID',
  CNL_COMPILER_AGENT_PLAN_TEMPLATE_COMPOUND_UNPROVABLE: 'CNL_COMPILER_AGENT_PLAN_TEMPLATE_COMPOUND_UNPROVABLE',
  ...
  CNL_COMPILER_AGENT_TURNSHAPE_REF_UNKNOWN: 'CNL_COMPILER_AGENT_TURNSHAPE_REF_UNKNOWN',
  CNL_COMPILER_AGENT_TURNSHAPE_OBJECTIVE_REQUIRES_VALUE_OR_DELTA: 'CNL_COMPILER_AGENT_TURNSHAPE_OBJECTIVE_REQUIRES_VALUE_OR_DELTA',
  CNL_COMPILER_AGENT_TURNSHAPE_OBJECTIVE_HAS_BOTH_VALUE_AND_DELTA: 'CNL_COMPILER_AGENT_TURNSHAPE_OBJECTIVE_HAS_BOTH_VALUE_AND_DELTA',
  CNL_COMPILER_AGENT_TURNSHAPE_REQUIRES_UNREGISTERED_PREVIEW_DRIVE: 'CNL_COMPILER_AGENT_TURNSHAPE_REQUIRES_UNREGISTERED_PREVIEW_DRIVE',
  CNL_COMPILER_AGENT_TURNSHAPE_FALLBACK_DEMOTE_REQUIRES_PENALTY: 'CNL_COMPILER_AGENT_TURNSHAPE_FALLBACK_DEMOTE_REQUIRES_PENALTY',
  CNL_COMPILER_AGENT_TURNSHAPE_DEPENDENCY_CYCLE: 'CNL_COMPILER_AGENT_TURNSHAPE_DEPENDENCY_CYCLE',
  CNL_COMPILER_AGENT_TURNSHAPE_OBJECTIVE_ID_DUPLICATE: 'CNL_COMPILER_AGENT_TURNSHAPE_OBJECTIVE_ID_DUPLICATE',
  CNL_COMPILER_AGENT_TURNSHAPE_TRACE_LABEL_DUPLICATE: 'CNL_COMPILER_AGENT_TURNSHAPE_TRACE_LABEL_DUPLICATE',
  CNL_COMPILER_AGENT_POSTURE_REF_UNKNOWN: 'CNL_COMPILER_AGENT_POSTURE_REF_UNKNOWN',
  CNL_COMPILER_AGENT_POSTURE_PREFER_REQUIRES_FALLBACK: 'CNL_COMPILER_AGENT_POSTURE_PREFER_REQUIRES_FALLBACK',
  CNL_COMPILER_AGENT_POSTURE_DEPENDENCY_CYCLE: 'CNL_COMPILER_AGENT_POSTURE_DEPENDENCY_CYCLE',
  CNL_COMPILER_AGENT_POSTURE_TRACE_LABEL_DUPLICATE: 'CNL_COMPILER_AGENT_POSTURE_TRACE_LABEL_DUPLICATE',
