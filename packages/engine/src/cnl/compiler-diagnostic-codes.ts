...
const COMPILER_DIAGNOSTIC_CODES_COMPILER_CORE = Object.freeze({
  ...
  CNL_COMPILER_SEAT_IDENTITY_INDEX_FORBIDDEN: 'CNL_COMPILER_SEAT_IDENTITY_INDEX_FORBIDDEN',
  CNL_COMPILER_SEAT_IDENTITY_CONTRACT_INCOHERENT: 'CNL_COMPILER_SEAT_IDENTITY_CONTRACT_INCOHERENT',
} as const);
