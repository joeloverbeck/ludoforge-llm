...
export const asBoundaryId = (value: string): BoundaryId => value as BoundaryId;
...
export const isBoundaryId = (value: unknown): value is BoundaryId => typeof value === 'string';
export const isTriggerId = (value: unknown): value is TriggerId => typeof value === 'string';
export const isSeatId = (value: unknown): value is SeatId => typeof value === 'string';
