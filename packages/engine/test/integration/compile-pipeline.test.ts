...
actor: 'active',
  ...
  it('preserves grantFreeOperation sequenceContext through the compile pipeline', () => {
    const compiled = compileGameSpecToGameDef({
      ...createEmptyGameSpecDoc(),
      metadata: { id: 'pipeline-free-operation-sequence-context', players: { min: 2, max: 2 } },
  ...
  it('accepts tokenZone field filters against dynamically keyed capturedSequenceZones references', () => {
    const markdown = [
      '```yaml',
      'metadata:',
      '  id: embedded-token-zone-origin-restriction',
      '  players:',
      '    min: 2',
      '    max: 2',
      'dataAssets:',
