  ...
  actionPipelines: [
    {
      ...
      legality: {
        op: 'in',
        item: { _t: 2 as const, ref: 'binding', name: 'target' },
        set: { _t: 2 as const, ref: 'grantContext', key: 'allowedTargets' },
      },
      costValidation: null,
      costEffects: [],
      targeting: {},
            ...
            freeOperationGrants: [
              {
                ...
                postResolutionTurnFlow: 'resumeCardFlow',
                executionContext: {
                  allowedTargets: { _t: 1 as const, scalarArray: [2] },
                  effectCode: 7,
                },
              },
            ],
            ...
            effects: [
              eff({
                grantFreeOperation: {
                  ...
                  postResolutionTurnFlow: 'resumeCardFlow',
                  executionContext: {
                    allowedTargets: { _t: 1 as const, scalarArray: [1] },
              ...
              freeOperationGrants: [
                ...
                },
                {
                  ...
                  zoneFilter: {
                    ...
                    set: { _t: 2 as const, ref: 'capturedSequenceZones', key: 'selected-space' },
                  },
                },
              ],
            },
              ...
              freeOperationGrants: [
                {
                  ...
                  zoneFilter: {
                    op: '==',
                    left: { _t: 2 as const, ref: 'zoneProp', zone: '$grantZone', prop: 'country' },
                    right: 'cambodia',
                  },
                },
              ],
