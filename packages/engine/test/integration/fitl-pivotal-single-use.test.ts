              ...
              left: {
                aggregate: {
                  ...
                  query: {
                    query: 'tokensInZone',
                    zone: 'leader:none',
                    filter: { op: 'and', args: [{ prop: 'cardId', op: 'eq', value: 'card-121' }] },
                  },
                },
              },
              right: 0,
              ...
              left: {
                aggregate: {
                  ...
                  query: {
                    query: 'tokensInZone',
                    zone: 'leader:none',
                    filter: { op: 'and', args: [{ prop: 'cardId', op: 'eq', value: 'card-122' }] },
                  },
                },
              },
              right: 0,
              ...
              left: {
                aggregate: {
                  ...
                  query: {
                    query: 'tokensInZone',
                    zone: 'leader:none',
                    filter: { op: 'and', args: [{ prop: 'cardId', op: 'eq', value: 'card-123' }] },
                  },
                },
              },
              right: 0,
              ...
              left: {
                aggregate: {
                  ...
                  query: {
                    query: 'tokensInZone',
                    zone: 'leader:none',
                    filter: { op: 'and', args: [{ prop: 'cardId', op: 'eq', value: 'card-124' }] },
                  },
                },
              },
              right: 0,
