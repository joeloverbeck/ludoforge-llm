  ...
  it('renders a continued-deepening no-counter residual split', async () => {
    ...
    const row = {
      ...
      hotPathBuckets: [
        ...
        { key: 'policyInnerPreviewDriveOption:publishMicroturn', count: 3, totalMs: 6 },
    ...
    assert.match(csv, /drive-option-subroutine-nested:3\/6ms/u);
    ...
    assert.match(markdown, /drive-option-subroutine-nested/u);
