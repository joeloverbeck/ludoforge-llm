  ...
  it('builds deterministic score ranking for highest and lowest modes', () => {
    ...
    const highestDef: GameDef = {
      ...
      terminal: {
        ...
        scoring: { method: 'highest', value: { _t: 2 as const, ref: 'pvar', player: 'actor', var: 'points' } },
      },
    };
    ...
    const lowestDef: GameDef = {
      ...
      terminal: {
        conditions: [{ when: { op: '==', left: 1, right: 1 }, result: { type: 'score' } }],
        scoring: { method: 'lowest', value: { _t: 2 as const, ref: 'pvar', player: 'actor', var: 'points' } },
      },
    };
        ...
        checkpoints: [
          {
            ...
            seat: 'us',
            timing: 'duringCoup',
            when: { op: '>', left: { _t: 2 as const, ref: 'gvar', var: 'done' }, right: 0 },
          },
        ],
      },
    };
  ...
  it('uses margin ranking to select during-coup winner when margins are defined', () => {
    const def: GameDef = {
      ...
      terminal: {
        ...
        margins: [
          { seat: 'us', value: { _t: 2 as const, ref: 'gvar', var: 'mUs' } },
          { seat: 'nva', value: { _t: 2 as const, ref: 'gvar', var: 'mNva' } },
          { seat: 'arvn', value: { _t: 2 as const, ref: 'gvar', var: 'mArvn' } },
        ],
        ...
        checkpoints: [
          {
            ...
            seat: 'us',
            timing: 'finalCoup',
            when: { op: '==', left: { _t: 2 as const, ref: 'gvar', var: 'finalCoup' }, right: 1 },
          },
        ],
        margins: [
          { seat: 'us', value: { _t: 2 as const, ref: 'gvar', var: 'mUs' } },
