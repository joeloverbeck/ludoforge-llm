...
describe('projectRenderModel zones/tokens/adjacencies', () => {
  it('projects zone category/attributes with provider-resolved visuals and labels', () => {
    ...
    expect(cityZone).toMatchObject({
      ...
      category: 'city',
      attributes: { population: 2, canFortify: true },
      visual: { shape: 'hexagon', width: 120, height: 80, color: '#123456', connectionStyleKey: null, vertices: null, strokeColor: null, strokeColor: null },
      metadata: {
        zoneKind: 'board',
        category: 'city',
        attributes: { population: 2, canFortify: true },
    ...
    expect(plainZone).toMatchObject({
      category: null,
      attributes: {},
      visual: { shape: 'rectangle', width: 160, height: 100, color: null, connectionStyleKey: null, vertices: null, strokeColor: null, strokeColor: null },
  ...
  it('does not preserve prior zone references during stabilization when resolved visual changes', () => {
    ...
    expect(secondModel.zones[0]).toMatchObject({
      category: 'city',
      visual: { shape: 'rectangle', color: '#222222', connectionStyleKey: null, vertices: null, strokeColor: null, strokeColor: null },
      metadata: {
        zoneKind: 'aux',
        category: 'city',
      },
