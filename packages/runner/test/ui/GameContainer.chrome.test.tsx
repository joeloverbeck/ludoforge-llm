...
vi.mock('../../src/ui/AnimationControls.js', () => ({
  AnimationControls: () => createElement('div'),
}));
...
function createContainerStore(): StoreApi<GameStore> {
...
describe('GameContainer chrome state', () => {
  ...
  it('resets event-log visibility when a new game store is mounted', async () => {
