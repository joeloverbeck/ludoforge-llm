...
function createGameStoreFixture(playerId: number | null, lifecycle: GameStore['gameLifecycle']): StoreApi<GameStore> {
  return createStore<GameStore>()(() => ({
    ...
    submitActionSelection: vi.fn(async () => {}),
    submitChoice: vi.fn(async () => {}),
    submitChooseNStep: vi.fn(async () => {}),
    runAiStep: vi.fn(async () => 'no-op' as const),
    ...
    rewindToCurrentTurnStart: vi.fn(async () => {}),
    undo: vi.fn(async () => {}),
