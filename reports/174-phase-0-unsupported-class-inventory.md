...
`runDeepPass` in `policy-preview-inner-deepening.ts` currently routes every `continuedDeepening` option through TypeScript. Therefore the deep phase has no live WASM fail-closed reason string today; its current unsupported class is the absence of a production WASM dispatch boundary. The follow-up owner is `174WASMDEEPPRV-008`, after tickets 002-007 establish the ABI and parity proof needed for activation.
...
|---|---|---:|---:|---|
| `train:chooseNStep:add` | `continuedDeepening` | 33 | 54546.24 | `174WASMDEEPPRV-003`, `174WASMDEEPPRV-005`, `174WASMDEEPPRV-006`, then `174WASMDEEPPRV-008` |
| `train:chooseNStep:confirm` | `continuedDeepening` | 35 | 39527.73 | `174WASMDEEPPRV-003`, `174WASMDEEPPRV-005`, `174WASMDEEPPRV-006`, then `174WASMDEEPPRV-008` |
| `coupArvnRedeployPolice:chooseOne` | `continuedDeepening` | 52 | 24104.97 | `174WASMDEEPPRV-003`, `174WASMDEEPPRV-004`, `174WASMDEEPPRV-006`, then `174WASMDEEPPRV-008` |
| `govern:chooseNStep:confirm` | `continuedDeepening` | 25 | 12791.11 | `174WASMDEEPPRV-003`, `174WASMDEEPPRV-005`, `174WASMDEEPPRV-006`, then `174WASMDEEPPRV-008` |
| `govern:chooseNStep:add` | `continuedDeepening` | 35 | 11820.45 | `174WASMDEEPPRV-003`, `174WASMDEEPPRV-005`, `174WASMDEEPPRV-006`, then `174WASMDEEPPRV-008` |
...
Dispatch callsites intentionally remain unchanged in this phase. Phase 3 activation (`174WASMDEEPPRV-008`) owns calling `recordProductionPolicyWasmPreviewDrive(...)` from broad-phase and deep-phase route activation sites, so fallback success cannot be mistaken for route activation.
