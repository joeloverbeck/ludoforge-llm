...
`runDeepPass` in `policy-preview-inner-deepening.ts` currently routes every `continuedDeepening` option through TypeScript. Therefore the deep phase has no live WASM fail-closed reason string today; its current unsupported class is the absence of a production WASM dispatch boundary. `174WASMDEEPPRV-008` records this as explicit unsupported deep-route telemetry; the materialized-state ABI and real deep activation owner is `174WASMDEEPPRV-011`.
...
|---|---|---:|---:|---|
| `train:chooseNStep:add` | `continuedDeepening` | 33 | 54546.24 | `174WASMDEEPPRV-003`, `174WASMDEEPPRV-005`, `174WASMDEEPPRV-006`, `174WASMDEEPPRV-008` telemetry, then `174WASMDEEPPRV-011` materialized-state activation |
| `train:chooseNStep:confirm` | `continuedDeepening` | 35 | 39527.73 | `174WASMDEEPPRV-003`, `174WASMDEEPPRV-005`, `174WASMDEEPPRV-006`, `174WASMDEEPPRV-008` telemetry, then `174WASMDEEPPRV-011` materialized-state activation |
| `coupArvnRedeployPolice:chooseOne` | `continuedDeepening` | 52 | 24104.97 | `174WASMDEEPPRV-003`, `174WASMDEEPPRV-004`, `174WASMDEEPPRV-006`, `174WASMDEEPPRV-008` telemetry, then `174WASMDEEPPRV-011` materialized-state activation |
| `govern:chooseNStep:confirm` | `continuedDeepening` | 25 | 12791.11 | `174WASMDEEPPRV-003`, `174WASMDEEPPRV-005`, `174WASMDEEPPRV-006`, `174WASMDEEPPRV-008` telemetry, then `174WASMDEEPPRV-011` materialized-state activation |
| `govern:chooseNStep:add` | `continuedDeepening` | 35 | 11820.45 | `174WASMDEEPPRV-003`, `174WASMDEEPPRV-005`, `174WASMDEEPPRV-006`, `174WASMDEEPPRV-008` telemetry, then `174WASMDEEPPRV-011` materialized-state activation |
