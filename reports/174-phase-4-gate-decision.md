...
Ticket `tickets/174WASMDEEPPRV-010.md` must not proceed with the default flip or A/B deletion. The fail-path blocker report is `reports/174-phase-4-architectural-blocker.md`, and the next implementation owner is `tickets/174WASMDEEPPRV-014.md`.
