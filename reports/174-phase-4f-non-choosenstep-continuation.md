...
The bounded witness does not improve wall time. It shifts formerly unsupported work into active route execution and leaves terminal-boundary/projected-state residuals explicit. `tickets/174WASMDEEPPRV-010.md` remains rejected, and a later ticket must own any renewed measured gate or default-flip decision.
