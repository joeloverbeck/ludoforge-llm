...
- [`tickets/164CONTPREVDEP-002.md`](../tickets/164CONTPREVDEP-002.md) — Compiler — strategy/capClass lowering, per-phase cost validation, diagnostics (covers §5.1 + §5.2 + §7 + Phase 1)
