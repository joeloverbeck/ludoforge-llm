...
- [`tickets/174WASMDEEPPRV-016.md`](../tickets/174WASMDEEPPRV-016.md) — Phase 4e — Diagnose train chooseNStep unsupported deepening residuals
...
Phase 4e handoff on 2026-05-16: `tickets/174WASMDEEPPRV-016.md` is the active continuation owner for the new dominant reason-granular unsupported `train:chooseNStep:add` and `train:chooseNStep:confirm` continued-deepening residuals. `tickets/174WASMDEEPPRV-010.md` remains rejected and must not be used for default flip or A/B deletion unless a later measured gate records a Pass.
