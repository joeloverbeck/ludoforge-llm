...
- [`archive/tickets/174WASMDEEPPRV-010.md`](../archive/tickets/174WASMDEEPPRV-010.md) — Phase 4b — Default flip and A/B wiring deletion (rejected because 009's perf gate failed)
...
- [`tickets/174WASMDEEPPRV-019.md`](../tickets/174WASMDEEPPRV-019.md) — Phase 4h — Rerun measured gate and identify next default-route owner
...
Phase 4h continuation on 2026-05-16: `tickets/174WASMDEEPPRV-019.md` owns the fresh broad measured gate rerun after Phase 4g. The architectural intent remains that supported chooseN/deep preview-drive paths should eventually run through WASM by default, but defaulting and deleting A-B routing requires a new broad gate Pass. If Phase 4h passes, the follow-up should be a new default-flip ticket rather than reopening archived `174WASMDEEPPRV-010`; if it fails, Phase 4h must name the next non-overlapping measured owner.
