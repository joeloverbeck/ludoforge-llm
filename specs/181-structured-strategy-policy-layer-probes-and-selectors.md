...
- [`archive/tickets/181STRSTRPOL-011.md`](../archive/tickets/181STRSTRPOL-011.md) — Phase 1 — Conformance test: fixture-game declared-product selector (covers §8 Phase 1 acceptance (b) declared-product)
