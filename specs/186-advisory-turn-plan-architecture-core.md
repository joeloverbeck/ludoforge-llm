...
- [`tickets/186ADVTURNPLAN-002A.md`](../tickets/186ADVTURNPLAN-002A.md) — Plan cap/max-step IR prerequisite for static validation (covers §4.4 cap metadata needed by §4.7)
...
- Boundary reset approved on 2026-05-20: `186ADVTURNPLAN-002A` now owns the missing plan cap/max-step IR prerequisite before `186ADVTURNPLAN-002` validates the cap-class and max-step diagnostics required by Foundations #10/#12.
