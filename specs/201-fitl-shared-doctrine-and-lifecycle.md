...
- [`tickets/201FITLSHADOC-001D.md`](../tickets/201FITLSHADOC-001D.md) — Schedule-distance refs in state features (Foundation #2/#15 prerequisite for `distanceToCoup`) — PENDING
