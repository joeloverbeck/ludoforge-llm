...
- **Spec 208 — FITL ARVN baseline profile-quality witness failures** — ✅ COMPLETED + ARCHIVED 2026-05-31 (`archive/specs/208-fitl-arvn-baseline-pq-witness-failures.md`). Three ARVN witnesses (`arvn-action-distribution-not-dominated`, `turn-shape-minimum-impact-observed`, `fitl-arvn-may17-equivalent-opponent-preview`) were diagnosed as legitimate post-Spec-191 trajectory drift, distilled to architectural invariants, and un-skipped with the full `policy-profile-quality` lane green.
