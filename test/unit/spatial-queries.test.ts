...
const makeDef = (): GameDef => ({
  ...
  perPlayerVars: [],
  zones: [
    { id: asZoneId('a:none'), owner: 'none', visibility: 'public', ordering: 'set', adjacentTo: [asZoneId('c:none'), asZoneId('b:none')] },
    { id: asZoneId('b:none'), owner: 'none', visibility: 'public', ordering: 'set', adjacentTo: [asZoneId('a:none'), asZoneId('d:none')] },
    { id: asZoneId('c:none'), owner: 'none', visibility: 'public', ordering: 'set', adjacentTo: [asZoneId('a:none'), asZoneId('d:none')] },
    { id: asZoneId('d:none'), owner: 'none', visibility: 'public', ordering: 'set', adjacentTo: [asZoneId('b:none'), asZoneId('c:none'), asZoneId('e:none')] },
    { id: asZoneId('e:none'), owner: 'none', visibility: 'public', ordering: 'set', adjacentTo: [asZoneId('d:none')] },
  ],
  tokenTypes: [],
  setup: [],
