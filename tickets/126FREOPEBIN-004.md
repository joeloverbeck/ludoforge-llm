...
**Deps**: `archive/tickets/126FREOPEBIN-001.md`, `archive/tickets/126FREOPEBIN-002.md`, `archive/tickets/126FREOPEBIN-003.md`, `archive/tickets/126FREOPEBIN-005.md`, `tickets/126FREOPEBIN-006.md`, `tickets/126FREOPEBIN-007.md`, `archive/tickets/126FREOPEBIN-008.md`
...
After tickets `126FREOPEBIN-006`, `126FREOPEBIN-007`, and `126FREOPEBIN-008` are implemented, re-run the seed scan across 1000–2200 with all 4 FITL PolicyAgent profiles and `MAX_TURNS=300`. Categorize results:
...
1. Integration: after `126FREOPEBIN-006`, `126FREOPEBIN-007`, and `126FREOPEBIN-008`, seeds 1010, 1012, 1014, 1015, 1019 reach `terminal`, `maxTurns`, or `agentStuck` — never crash
...
1. Zero crashes across all scanned seeds after the `126FREOPEBIN-006`/`007`/`008` engine chain
2. Zero hangs across all scanned seeds after the `126FREOPEBIN-006`/`007`/`008` engine chain
...
- Blocking remainder:
  ...
  - The engine-side prerequisite series is now landed; this ticket can resume the scan/canary deliverables on top of those fixes.
