...
**Status**: BLOCKED by Phase 5/WASM successor gate `tickets/150FITLWASM-022.md` — final F14 default-flip/deletion owner
**Priority**: HIGH
**Effort**: Large
...
red around `2.5 s`. The active successor owner is now
`tickets/150FITLWASM-022.md`; this ticket remains blocked until that or a later
successor makes the budget truthful.
