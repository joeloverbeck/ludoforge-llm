...
**Status**: BLOCKED by Phase 5/WASM successor gate `tickets/150FITLWASM-021.md` — final F14 default-flip/deletion owner
**Priority**: HIGH
**Effort**: Large
...
query/apply/hash residual is now `tickets/150FITLWASM-021.md`; this ticket
