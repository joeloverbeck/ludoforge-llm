...
2. Confirmed activation counters (`getProductionPolicyWasmPreviewDriveRouteCount`, `getProductionPolicyWasmPreviewDriveUnsupportedCount`) are exported from `policy-wasm-runtime.ts` after ticket 001 lands and incremented by ticket 008.
...
Run: `node packages/engine/scripts/profile-fitl-arvn-15-seed-decomposition.mjs --seeds 1000..1014 --timeout-ms 400000 --date 2026-05-15-post-174-008 --profile-buckets`

Capture:
- `reports/fitl-arvn-15-seed-decomposition-2026-05-15-post-174-008.md`
- `reports/fitl-arvn-15-seed-decomposition-2026-05-15-post-174-008.csv`
...
- `reports/fitl-arvn-15-seed-decomposition-2026-05-15-post-174-008.md` (new — witness output)
- `reports/fitl-arvn-15-seed-decomposition-2026-05-15-post-174-008.csv` (new — witness CSV)
...
2. `node packages/engine/scripts/profile-fitl-arvn-15-seed-decomposition.mjs --seeds 1000..1014 --timeout-ms 400000 --date <YYYY-MM-DD>-post-174-008 --profile-buckets`
