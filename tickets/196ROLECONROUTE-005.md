...
- **Missing prerequisite**: Production post-state role-constraint probing could not yet materialize all generic params needed for an operation plus compound special activity, specifically FITL Train `chooseNStep` params together with Transport special-activity params. That substrate was owned by `archive/tickets/196ROLECONROUTE-005B.md`.
- **Successor / continuation owner**: `archive/tickets/196ROLECONROUTE-005B.md` landed on 2026-05-26; this ticket is now unblocked and owns the concrete FITL ARVN Transport origin-control migration.
- **Dependency/spec rewrites**: This ticket now depends on `archive/tickets/196ROLECONROUTE-005B.md`; the originating spec ticket list names the new prerequisite before this ticket.
...
- **Archive status**: Not archive-ready; this ticket remains active and now pending implementation of the concrete FITL origin-control admissibility semantics.
- **Next workflow**: `$implement-ticket tickets/196ROLECONROUTE-005.md . Rely on specs/196-generic-role-constraints-and-authored-route-semantics.md`.
