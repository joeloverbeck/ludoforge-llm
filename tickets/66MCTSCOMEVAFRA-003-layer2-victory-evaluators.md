...
- `packages/engine/test/unit/e2e-helpers/fitl-competence-evaluators.test.ts` (modify — add 8 tests)
...
1. `packages/engine/test/unit/e2e-helpers/fitl-competence-evaluators.test.ts` — 8 new test cases
