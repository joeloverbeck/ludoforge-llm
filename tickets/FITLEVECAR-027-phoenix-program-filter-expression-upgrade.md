...
**Deps**: tickets/TOKFILAST-001-token-query-filter-expression-unification.md, tickets/TOKFILAST-002-cnl-lowering-and-no-shim-migration.md, specs/29-fitl-event-card-encoding.md
