...
- `test/fixtures/cnl/compiler/fitl-operations-insurgent.md` — Replace `rally-profile` stub with `rally-nva-profile` YAML
- `data/games/fire-in-the-lake.md` — Add `rally-nva-profile` operation profile
