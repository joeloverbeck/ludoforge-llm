...
- Ticket tooling integrity work (`tickets/KERQUERY-016-enforce-active-ticket-reference-integrity-after-archival.md`, `tickets/KERQUERY-020-enforce-archived-outcome-fact-integrity.md`)
